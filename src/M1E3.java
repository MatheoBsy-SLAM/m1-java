...
public class M1E3 {
    public static void main(String[] args){
        ...
        //4. Calculer le nombre d'heures avant minuit

        int totalSecondes = heures * 3600
        + minutes * 60
        + secondes;
        
        int nmbsecondes = 86400-totalSecondes;
        clavier.close();

    System.out.println ("Il est "+ heures + "h " + minutes + "min " + secondes + "s. Il s'est écoulé " + nmbsecondes + "secondes depuis minuit. ");
    }
}